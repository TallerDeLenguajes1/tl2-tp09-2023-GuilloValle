...
{   
    ...
    public Tablero CrearNuevoTablero(Tablero tablero){
            ...
            using (SQLiteConnection connection = new SQLiteConnection(cadenaConexion))
            {
                ...
                command.Parameters.Add(new SQLiteParameter("@Nombre_de_usuario", tablero.Nombre));
                command.Parameters.Add(new SQLiteParameter("@Nombre_de_usuario", tablero.NombreDeUsuario));
